...
const OpnionOfUser = forwardRef((props, refPositionDiv) => {
    ...
    function returnIframeForm() {
        return <iframe src="https://docs.google.com/forms/d/e/1FAIpQLSeHjepNBReQJj3Je9RKrd8EzZqdDdMzysfgYvUjrTD4rbipWA/viewform?embedded=true" id="iframe-form" title="iframe-form-google" width="72%" height="350px"  frameborder="0" marginheight="0" marginwidth="0">Carregando…</iframe>
    }
