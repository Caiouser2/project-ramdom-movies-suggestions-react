...
export default function  PrivacyPolicy(props) {
    ...
    if (props.activeCard === 'hide') {
        classNamePrivacyPolicy += 'hide';
    } else {
        classNamePrivacyPolicy += 'show';
    }

    return(
        <div className={classNamePrivacyPolicy} onClick={props.closeCardPrivacyPolicy} title="Clique em qualquer lugar fora do pop up para fechar">
            <div className="align-button" title="Clique para fechar pop up com política de privacidade">
                <div className="button-cancel" onClick={props.closeCardPrivacyPolicy} >
                    <h1>X</h1>  
                </div>
            </div>
            <div className="align-privacy-policy" title="política de privacidade">
                ...
                <p>Informamos que toda e qualquer informação pessoal coletada por por nosso website ramdommovies.dev.br , será utilizada para melhorar a sua experiência ao navegar em nosso website, visando desta maneira que sua visita se torne mais vantajosa e assertiva.</p>
                <p>A confidencialidade das informações pessoais dos usuários do site ramdommovies.dev.br é de suma importância para nossa equipe, por este motivo, buscamos otimizar continuamente todos os processos internos, utilizando o <a href="https://www.toneladas.blog.br/gerador-de-politica-de-privacidade-gerar-criar-online/">gerador de politica de privacidade</a> de forma clara, para mante-los em segurança e de acordo com todas as normas impostas.</p>
                <br></br>
                <h3>SEÇÃO II - COLETA DOS DADOS</h3>
                <p>Os dados pessoais dos visitantes podem ser coletados quando:</p>
                <p><strong>II.I</strong> - O indivíduo realiza a criação de um cadastro no site ramdommovies.dev.br e com base nisso podem ser solicitados dados como: email, nome, cidade, telefone, etc.</p>
                <p><strong>II.II</strong> - O indivíduo navega nas páginas de nosso site ramdommovies.dev.br e neste caso, podem ser coletados dados como: palavras-chaves de origem do buscador, comentários, navegador utilizado, IP da rede, etc.</p>
                ...
                <p>A partir do momento da utilização do website ramdommovies.dev.br pressupõe que o usuário aceitou a <strong>política de privacidade.</strong> Desta forma reservamos ao direito de modificar esta política sem que seja realizado um aviso prévio. Por este motivo, nós recomendamos que os usuários realizem uma consulta regularmente a nossa política, para que desta forma, se mantenham sempre atualizados de possíveis alterações, caso seja necessário é possível entrar em contato através de nosso e-mail:ramdommoviecontact@gmail.com informando suas dúvidas.</p>
                ...
                <p>O site ramdommovies.dev.br pode conter vinculo com sites externos, estes que podem possuir ferramentas e/ou informações proveitosas para os usuários. Esta <strong>política de privacidade</strong> não é empregada aos sites externos, se for do interesse do usuário, o mesmo deverá acessar a <strong>política de privacidade</strong> do site em questão para ter conhecimento dos detalhes.</p>
                <br></br>
                ...
                <p>A nossa empresa utiliza o serviço do Google Analytics para mensurar, calcular e analisar todo o tráfego que recebe no site ramdommovies.dev.br esta ferramenta coleta e processa os dados de acordo com a sua própria política, partindo do pressuposto da aceitação do usuário final, a política está disponível nos links abaixo:</p>
                <ul>
                ...
                <p>Vale ressaltar que no caso do Google ou Parceiros deste, utilizarem os dados coletados, a responsabilidade é única e exclusiva destes, desta forma o site ramdommovies.dev.br se isenta de qualquer responsabilidade por consequência do uso dos dados.</p>
            </div>
        </div>
    );
}